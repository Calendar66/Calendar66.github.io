...
4. Buffer memory flags。
5. Buffer memory type index(property,optional)。
一个Buffer的创建流程可以简化为：
...
[VMA PDF文档｜Generated by Doxygen](https://drive.google.com/file/d/1UUdl3FJjDqUbCYhrzNWvsavK8ewfMFPA/view?usp=sharing)
